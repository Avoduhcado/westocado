...
import com.avogine.westocado.render.data.Vertex;
...
public class OBJFileLoader {
	...
	private static Map<String, ModelData> modelMap = new HashMap<>(); 

	public static ModelData loadOBJ(String objFileName) {
		ModelData data = modelMap.get(objFileName);
		if(data != null) {
			//System.out.println("EFFICIENT");
			return data;
		}
		
		InputStreamReader isr = new InputStreamReader(ClassLoader.getSystemResourceAsStream(RES_LOC + objFileName + OBJ_EXT));
		...
		data = new ModelData(verticesArray, texturesArray, normalsArray, indicesArray, furthest);
		modelMap.put(objFileName, data);
